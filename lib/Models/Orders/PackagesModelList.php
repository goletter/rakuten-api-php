 ...
 */
class PackagesModelList implements ModelInterface, ArrayAccess, IterableType
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'PackagesModelList';
